...
`,
		...
		},
		{
			...
			Want: `
				...
				kube_pod_status_ready_time_affirm{namespace="ns1",pod="pod1",uid="uid1"} 1.501666018e+09
		...
		},
		{
			...
			Want: `
		        ...
		        # TYPE kube_pod_status_ready gauge
		        # TYPE kube_pod_status_ready_time_affirm gauge
		        kube_pod_status_ready_time_affirm{namespace="ns2",pod="pod2",uid="uid2"} 1.501666018e+09
